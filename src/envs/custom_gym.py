...
def make__FrozenLake_OneHot_StepPenalty(render_mode=None, is_slippery=False, gamma=0.99):
...
if env_id not in gym.envs.registry:
    register(id=env_id, entry_point='src.envs.custom_games:make__FrozenLake_OneHot_StepPenalty')



# Testing only
if __name__ == '__main__':
    env = gym.make('custom/FrozenLake-OneHot-StepPenalty', render_mode='human')
